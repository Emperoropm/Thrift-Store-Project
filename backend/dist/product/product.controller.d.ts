...
export declare class ProductController {
    ...
    getProductById(request: Request, response: Response, next: NextFunction): Promise<void>;
    ...
    getProductsBySellerIdPublic: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    ...
    getNearbyProducts(req: Request, res: Response, next: NextFunction): Promise<void>;
}
